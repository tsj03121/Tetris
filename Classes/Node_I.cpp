...
Node_I::Node_I(int x, int y)
: MyNode(x, y)
{
    RotSetting();
}

Layer* Node_I::getNodeLayer()
{
    return pMyNodeLayer_;
}

//블록 회전 경우의 수
void Node_I::RotSetting()
{
    ...
    switch (rotation_)
    {
        case 0:
        {
            pSprite_[0]->setPosition(Vec2((myX_ * 30), ((myY_+1) * 30)));
            pSprite_[1]->setPosition(Vec2((myX_ * 30), (myY_ * 30)));
            pSprite_[2]->setPosition(Vec2((myX_ * 30), ((myY_-1) * 30)));
            pSprite_[3]->setPosition(Vec2((myX_ * 30), ((myY_-2) * 30)));
            break;
        }
        case 1:
        {
            pSprite_[0]->setPosition(Vec2(((myX_ + 1) * 30), ((myY_) * 30)));
            pSprite_[1]->setPosition(Vec2(((myX_) * 30), (myY_ * 30)));
            pSprite_[2]->setPosition(Vec2(((myX_ - 1) * 30), ((myY_) * 30)));
            pSprite_[3]->setPosition(Vec2(((myX_ - 2) * 30), ((myY_) * 30)));
            break;
        }
        case 2:
        {
            ...
            pSprite_[3]->setPosition(Vec2(((myX_ - 1) * 30), ((myY_-2) * 30)));
            break;
        }
        case 3:
        {
            pSprite_[0]->setPosition(Vec2(((myX_ - 2) * 30), ((myY_+ 1) * 30)));
